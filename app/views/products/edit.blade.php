        ...
        <div class="col-md-12">
            ...
            <section class="panel">
                ...
                <div class="panel-body">
                    ...
                    {{ Form::model($product, ['role' => 'form', 'route' => ['products.update', $product->id], 'method' => 'PUT','files' => true]) }}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            {{ Form::textarea('details', null, array('class' => 'form-control', 'placeholder' => 'Enter Product Details')) }}
                        </div>
                        <br><br>
                    </div>
